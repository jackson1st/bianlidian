...
//        segmented.addTarget(<#T##target: AnyObject?##AnyObject?#>, action: <#T##Selector#>, forControlEvents: <#T##UIControlEvents#>)
    }
...
extension OrderViewController {
    ...
    func loadDataModel() {
        ...
        let parameters = ["custNo":"cu001","pageIndex":1,"pageCount":5]
